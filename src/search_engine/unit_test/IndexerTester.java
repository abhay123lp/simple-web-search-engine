...
public class IndexerTester {
	...
	@Test
	public void overlapIndexDocument() {
		int testId = 4;
		...
		try {
			...
			index2Timer.schedule(new ThreadIndexer("www.anotherdummy.com", "Another simple text file Yes this is yes"), 12);
	...
	@Test
	public void conccurentIndexDocument() {
		int testId = 5;
