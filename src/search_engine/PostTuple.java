...
/**
 * This class provides an implementation of a tuple {@code<docId, tf>}
 * in which tf is term frequency: number of appearance of a particular vocabulary
 * in the document with stored docId <br/>
 *  
 * @author ngtrhieu0011
 *
 */
