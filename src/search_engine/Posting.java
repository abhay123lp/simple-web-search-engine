...
/**
 * Posting provides a local posting, which will contains a list of document ID in which a word appear <br/>
 * This class supports <b>Comparable</b>, which used to sort Posting based on the vocabularyId the Posting has <br/>
 *  
 * @author ngtrhieu0011
 * 
 */
